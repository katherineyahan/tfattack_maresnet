...
class Attention(nn.Module):
    ...
    def __init__(self, block_num, class_num=2):
        ...
        self.stage1_1 = self._make_stage_1(8, 8, 3, block_num[0], AttentionModule1)
        self.stage1_2 = self._make_stage_1(8, 8, 5, block_num[0], AttentionModule1)
        self.stage1_3 = self._make_stage_1(8, 8, 9, block_num[0], AttentionModule1)
        self.stage2 = self._make_stage(24, 16, block_num[1], AttentionModule2)
        self.stage3 = self._make_stage(16, 16, block_num[2], AttentionModule3)
        self.stage4 = nn.Sequential(
            PreActResidualUnit(16, 16, 2, is_turn=True),
        )
